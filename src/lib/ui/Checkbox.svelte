...
>
	<input
		...
		bind:checked
		onchange={onChange}
		class="mt-0.5 w-5 h-5 rounded accent-foreground bg-primary border-foreground/30 focus:ring-2 focus:ring-offset-2 focus:ring-offset-primary focus:ring-foreground cursor-pointer disabled:cursor-not-allowed"
	/>
