...
export function getJsonLdBreadcrumb ({ categoryTitle, categorySlug, title, slug }: JsonldBreadcrumbParam): WithContext<BreadcrumbList> {
  return {
    '@context': 'https://schema.org',
    '@type': 'BreadcrumbList',
    itemListElement: [
...
export function getJsonLdArticle ({ slug, title, cover, desc }: JsonldArticleParam): WithContext<Article> {
  return {
    '@context': 'https://schema.org',
    '@type': 'NewsArticle',
    mainEntityOfPage: {
