...
{#if current == LANGUAGE_OPTIONS.ENGLISH.locale}
	<article class="px-4">
		<p class="mb-4">
			...
			to install additional applications, without ads, and without any analytics, making it safer
			for your data privacy.
		</p>

		<p class="mb-2">Baca-Quran.id using various data sources, including:</p>
		...
		<ul class="list-decimal ml-6 mb-4">
			<li>
				...
				>
				by Rio Astamal for the data source of the Qur'anic verses.
			</li>
			<li>
				<a
					class="underline"
			...
			<li>
				...
				>
				To get reverse geocoding information as part of the requirements to get schedule data pray
			</li>
		</ul>
		...
		<ul class="list-decimal ml-6 mb-4">
			<li>
				...
				Easy and FREE Link Shorten
			</li>
			<li>
				<a class="underline" href="https://www.tanyaaja.in/" target="_blank" rel="noopener"
					>TanyaAja.in,
				</a>
				Collect questions anonymously from anyone easily
			</li>
		</ul>
	</article>
{:else}
	<article class="px-4">
		<p class="mb-4">
			Baca-Quran.id merupakan aplikasi untuk membaca Al-Quran melalui peramban (browser), tanpa
			perlu lagi install aplikasi tambahan, tanpa iklan dan tanpa analitik apapun sehingga lebih
			aman untuk privasi data Anda.
		</p>
